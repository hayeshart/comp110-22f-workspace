...
end_postion: Point2D = (99.0, 99.0)

#tuples, because they are a sequence, are 0-indexed
print(start_position[0])

for item in end_postion:
    print(item)


print(len(end_postion))
...
# If you only ask one argument to range, it specifies 
#the stop marker and start is 0 
